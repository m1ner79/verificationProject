...
class GornickiMichalTestTask1 {
    ...
    public void testConstructor_withMinimumValues() {
        ...
        // Create empty periods for reduced period and normal period
        ArrayList<Period> reducedPeriods = new ArrayList<Period>();
        ArrayList<Period> normalPeriods = new ArrayList<Period>();
    ...
    public void testConstructor_withMaximumNormalRate() {
        ...
        // Create empty lists for reduced and normal periods
        ArrayList<Period> reducedPeriods = new ArrayList<Period>();
        ArrayList<Period> normalPeriods = new ArrayList<Period>();
    ...
    public void testConstructor_withNullCarParkKind() {
        ...
        // Call the constructor and expect an IllegalArgumentException to be thrown
        assertThrows(IllegalArgumentException.class, () -> new Rate(normalRate, reducedRate, null, reducedPeriods, normalPeriods));
    }
...
//CALCULATE METHOD TEST CASES
    ...
    public void testCalculate_withOverlappingNormalAndReducedPeriod() {
        ...
        // Calculate the rate for overlapping period
        Period period = new Period(11, 15);
        BigDecimal cost = rate.calculate(period);

        // Verify that the calculated rate matches the expected value
        BigDecimal expectedRate = new BigDecimal(14);
        assertEquals(expectedRate, cost);
    }
    ...
    public void testCalculate_includingNormalPeriodAndFreePeriod() {
        ...
        Period period = new Period(22, 6); // From 10pm to 6am the next day
        BigDecimal cost = rate.calculate(period);
